<template>
      ...
      <div class="pt-[52px]">
        ...
        >
          ...
          <div class="flex justify-end">
            ...
            >
              See More
              <img src="../asset/icons/detail.svg" class="cursor-pointer" @click="openModal(index)"/>
            </div>
          </div>
        </div>
      </div>
  ...
  <h2 class="text-2xl font-semibold">{{ selectedPost.title }}</h2>
  <p class="text-gray-700" v-html="selectedPost.body"></p>
</Modal>
    </div>
  </template>
  ...
  import Modal from '../components/PostDetailModal.vue'
  export default {
    name: "PostsList",
    props: {
      users: Array,
    ...
    const selectedPost = ref(null);
      const postList = [
        {
          title: "Post 1 Title",
          body: "Body Union Health Minister Shri Mansukh Mandaviya reviews #COVID19 <br> response in Kerala with Chief Minister Shri Pinarayi Vijayan and <br> Health Minister of Kerala, Ms. Veena George.",
        },
        {
          title: "Post 2 Title",
          body: "Body Union Health Minister Shri Mansukh Mandaviya reviews #COVID19 <br> response in Kerala with Chief Minister Shri Pinarayi Vijayan and <br> Health Minister of Kerala, Ms. Veena George.",
